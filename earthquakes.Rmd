...
The previous task hopefully revealed that some "earthquakes" are actually not earthquakes at all. Taking this into account, investigate elapsed time between true earthquakes. 
...
Consider locations that had at least 3 earthquakes, which location had the highest mean magnitude.
...
# create a palette function; OrRd is a palette from the RColorBrewer package
