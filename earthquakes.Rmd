...
The times look like they're character values, but that's just how they print. Internally they are stored as number of seconds since January 1, 1970. We can see that by calling `as.numeric()` on the times.
...
The elapsed time between the first two earthquakes in our data was 648.372 seconds. (The raw data has time down to the thousandth of a second!) That's about 10.8 minutes.
...
- What is the median elapsed times between earthquakes? In other words, about how often do earthquakes occur on earth?
